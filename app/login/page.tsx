...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen grid lg:grid-cols-2 bg-white selection:bg-emerald-lime selection:text-jet-black font-body">
      ...
      <div className="relative flex items-center justify-center p-4 sm:p-8 bg-soft-gray/30 min-h-screen lg:min-h-0">
        <AnimatePresence mode="wait">
          {!isLoading ? (
            <motion.div 
              ...
              exit={{ opacity: 0, x: -20 }}
              className="w-full max-w-md bg-white p-6 sm:p-10 rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.05)] border border-jet-black/5"
            >
